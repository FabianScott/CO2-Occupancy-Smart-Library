...
ppm_factor = 1
#         Q_adj        Q_out    C_out        m in mg/s (11*24.45/44.01, 11.1*24.45/44.01)
bounds = ((0, 2/(60*60)), (0, 4/(60*60)), (300/ppm_factor, 500/ppm_factor), (11*24.45/44.01, 11.1*24.45/44.01))
bounds_davide = ((0, 2/(60*60)), (0, .25/(60*60)), (300/ppm_factor, 500/ppm_factor), (6*24.45/44.01, 11.1*24.45/44.01))
# V in m^3:
